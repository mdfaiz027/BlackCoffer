...
public class MarketRecyclerViewAdapter extends RecyclerView.Adapter<MarketRecyclerViewAdapter.MyViewHolder> {
    ...
    public MarketRecyclerViewAdapter(List<MyModel> myList) {
        this.myList = myList;
    }

    @NonNull
    @Override
    public MarketRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate the layout for each item in the RecyclerView
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.market_custom_layout, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull MarketRecyclerViewAdapter.MyViewHolder holder, int position) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView profile_pic, phone_call, add_contact, location;
