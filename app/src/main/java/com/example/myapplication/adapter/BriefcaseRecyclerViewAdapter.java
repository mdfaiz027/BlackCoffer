...
public class BriefcaseRecyclerViewAdapter extends RecyclerView.Adapter<BriefcaseRecyclerViewAdapter.MyViewHolder> {

    private List<MyModel> myList; // List of model objects

    public BriefcaseRecyclerViewAdapter(List<MyModel> myList) {
        this.myList = myList;
    }

    @NonNull
    @Override
    public BriefcaseRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate the layout for each item in the RecyclerView
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.briefcase_custom_layout, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull BriefcaseRecyclerViewAdapter.MyViewHolder holder, int position) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView profile_pic, phone_call, add_contact;
        public MyViewHolder(@NonNull View itemView) {
            ...
            add_contact = itemView.findViewById(R.id.add_contact);
        }
    }
}
